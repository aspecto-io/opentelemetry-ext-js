...
**Compatible with [SDK stable ^1.0.0](https://github.com/open-telemetry/opentelemetry-js/tree/stable/v1.0.0) and [SDK experimental ^0.30.0](https://github.com/open-telemetry/opentelemetry-js/tree/experimental/v0.30.0)**
## Instrumentations
